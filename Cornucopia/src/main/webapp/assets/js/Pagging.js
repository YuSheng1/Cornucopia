...
function preLink() { spanPre.innerHTML = "<button class='btn btn-primary btn-sm' onclick='javascript:pre();'>上一页</button>"; }
function preNoLink(){ spanPre.innerHTML = "<button class='btn btn-primary btn-sm' disabled='disabled'>上一页</button>"; }

function nextLink() { spanNext.innerHTML = "<button class='btn btn-primary btn-sm' onclick='javascript:next();'>下一页</button>"; }
function nextNoLink(){ spanNext.innerHTML = "<button class='btn btn-primary btn-sm' disabled='disabled'>下一页</button>";}

function firstLink() { spanFirst.innerHTML = "<button class='btn btn-primary btn-sm' onclick='javascript:first();'>首页</button>"; }
function firstNoLink(){ spanFirst.innerHTML = "<button class='btn btn-primary btn-sm' disabled='disabled'>首页</button>";}

function lastLink() { spanLast.innerHTML = "<button class='btn btn-primary btn-sm' onclick='javascript:last();'>尾页</button>"; }
function lastNoLink(){ spanLast.innerHTML = "<button class='btn btn-primary btn-sm' disabled='disabled'>尾页</button>";}
