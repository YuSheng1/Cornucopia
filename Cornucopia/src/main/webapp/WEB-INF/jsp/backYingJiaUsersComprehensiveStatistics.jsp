...
<body>
		...
		<div id="page-wrapper">
			...
			<form class="form-inline" role="form" method="post">
	         ...
	         <input type="text" class="form-control" placeholder="号码11位" style="width: 150px; float: left;" maxlength="11"  id="phone" name="phone" value="${phone }">
			 &nbsp;&nbsp;
			 <span id="s" style="display:none ; color: red; float: left;">    手机号码必须为11位</span>
			 <br><br>
			 &nbsp;&nbsp;开始时间：
	         <input type="date" class="form-control" style="width: 120px" name="start" value="${start }">
	         &nbsp;&nbsp;结束时间：
	         <input type="date" class="form-control" style="width: 120px" name="end" value="${end }">
	         &nbsp;&nbsp;交易类型：
	          <select class="form-control" name="qtrade_type">
	         ...
	         &nbsp;&nbsp;
	         <input type="button" class="btn btn-default btn-info" value="查询" onclick="fun()">
	         &nbsp;
	         <input type="reset" class="btn btn-default btn-info" value="重置"><br>
	         <a>  <br> </a>
	         <div>
			<table class="table table-bordered" style="width: 45%; float:left;" >
			   ...
			   <table class="table table-bordered" style="width: 45%; float:left; margin-left: 15px;">
			   <caption></caption>
			   <thead>
			      <tr class="info">
			      	<th>资金信息</th>
			   ...
			   <c:forEach items="${tradeList }" var="t" varStatus="stat">
			      <tr>
			      	...
			      	<td>${t.amount }</td>
			      	<td>${t.trade_name }</td>
			      	<c:if test="${t.trade_status==0 }"><td>投资中</td></c:if>
			      	<c:if test="${t.trade_status==1 }"><td>完成</td></c:if>
			      	<td>${t.create_date }</td>
			      	<td>${t.trade_name }</td>
			      </tr>
			   </c:forEach>
