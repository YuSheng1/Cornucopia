...
<input type="submit" value="搜索"  class="btn btn-primary">
	...
	<div class="rightinfo">
		<table class="tablelist" id="t_student">
			...
			<tbody>
				<c:forEach items="${memberslist}" var="m" varStatus="stat">
					<tr>
						<td>${m.id }</td>
						...
						<td>${m.create_date }</td>
						<td>
						<a class="tablelink"  href="/Cornucopia/BgItem/BgAMX?memberId=${m.id}&mname=${m.name}" > <img src="../BgAssets/images/t01.png" />用户查询</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
