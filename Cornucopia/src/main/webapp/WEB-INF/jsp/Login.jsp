...
<link href="/resources/web/font/iconfont.css" rel="stylesheet"
	type="text/css" />
		...
		<div class="container">
			...
			<div class="section-container">
				<div class="am-g">
					...
					<!-- 用户登陆 -->
					<form action="/Cornucopia/item/Index" method="post">
						<!--contact-right start-->
						<div class="am-u-md-7">
							<div class="contact-form">
								<h3 class="contact-form_title" style="margin-left: 150px;">梵雅金融</h3>
								<br>
								<br>

								<div class="am-g">
									<div class="am-u-md-6">
										<h3 class="contact-form_title" style="margin-left: -15px;">用户名:</h3>
								...
								<div class="am-g">
									<div class="am-u-md-6">
										<h3 class="contact-form_title"
											style="margin-left: -15px; margin-top: 35px;">密 码:</h3>
										<input type="password" class="" id="doc-ipt-email-3"
											placeholder="请输入密码"
							...
							<div class="am-g">
								<div class="am-u-md-3">
									<p>
										<button type="submit"
											class="am-btn am-btn-default btn-reguest am-fr btn-fl"
											style="margin-top: 30px; margin-left: -50px;">登陆</button>
									</p>
								</div>
							</div>
